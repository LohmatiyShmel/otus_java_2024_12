...
public class DataController {
    ...
    @GetMapping(value = "/msg/all/{roomId}", produces = MediaType.APPLICATION_NDJSON_VALUE)
    public Flux<MessageDto> getAllMessagesForRoomId(@PathVariable("roomId") String roomId) {
        return Mono.just(roomId)
                .doOnNext(room -> log.info("getAllMessages for room = " + room))
